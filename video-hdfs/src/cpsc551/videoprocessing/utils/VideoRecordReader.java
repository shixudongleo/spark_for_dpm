...
class VideoRecordReader extends RecordReader<Text, Image> {
	...
	public static final String LocalTempPath = "/home/vutrang/InputVideos/";
	public static final String LocalOutputMainPath = "/home/vutrang/OutputFrames/";
	public static final String AbstractorPath = "/home/vutrang/main";
	...
	public void initialize(InputSplit split, TaskAttemptContext context)
        ...
        this.grabber = new FFmpegFrameGrabber(tempFilepath);
        System.out.println(tempFilepath + filename);
        try {
			grabber.start();
			System.out.println("start of video:" + filename);
		    IplImage grabbedImage = grabber.grab();
			cvSaveImage("/home/vutrang/OutputFrames/test.jpg", grabbedImage);
