						 ...
						 uint8_t * const *, void *))
{
    ...
    instance = (vo_instance_t *) calloc (1, sizeof (vo_instance_t));
    if (instance == NULL)
	return NULL;
...
static int null_setup (vo_instance_t * instance,
...
static int nullslice_setup (vo_instance_t * instance,
		            unsigned int width,
			    unsigned int height,
...
static int nullrgb16_setup (vo_instance_t * instance,
		            unsigned int width,
			    unsigned int height,
		            unsigned int display_width,
			    unsigned int display_height,
...
static int nullrgb32_setup (vo_instance_t * instance,
		            unsigned int width,
			    unsigned int height,
		            unsigned int display_width,
			    unsigned int display_height,
